...
import { bulkDeleteBranches, getAllBranches } from "@/app/actions/branches.actions";
...
export default async function Page( {searchParams} : SearchParams ) {
    ...
    const { data, totalRecords } = await getAllBranches({
        ...
        <>
            <div className="flex items-center ">
                <div className="ml-auto flex items-center gap-4">
                    ...
                    <AddNewLinkButton href="/branches/add" />
                </div>
            </div>
            ...
            <div className="overflow-hidden">
                <Suspense fallback={<Loading />}>
                    <CustomDataTable
                        ...
                        deleteServerAction={bulkDeleteBranches}
                        page={resolvedSearchParams?.page}
                    />
                </Suspense>
            </div>
