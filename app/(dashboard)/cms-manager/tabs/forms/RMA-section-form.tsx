...
type RmaSectionProps = {
    pageId: string | null;
    content: RmaSection | null;
...
const RmaSectionForm = ({
    ...
    // Initial Values
    const initialValues: RmaSection = useMemo(
        () => ({
            id: content?.id || "",
            type: "RmaSection",
    ...
    const handleSubmit = async (
        values: RmaSection,
        { resetForm }: FormikHelpers<RmaSection>,
