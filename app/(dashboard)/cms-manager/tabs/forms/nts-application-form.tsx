...
type NTSApplicationSection = Omit<Section, ""> & {
    data: {
        //link?: string;
        paddingtop: number;
...
type NTSApplicationProps = {
    pageId: string | null;
    content: NTSApplicationSection | null;
...
const NTSApplicationForm = ({
    ...
    // Initial Values
    const initialValues: NTSApplicationSection = useMemo(
        () => ({
            id: content?.id || "",
            type: "NTSApplication",
    ...
    const handleSubmit = async (
        values: NTSApplicationSection,
        { resetForm }: FormikHelpers<NTSApplicationSection>,
