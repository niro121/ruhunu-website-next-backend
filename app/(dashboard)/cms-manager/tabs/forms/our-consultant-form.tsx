...
type ConsultantSection = Omit<Section, ""> & {
    data: {
        paddingtop: number;
...
type ConsultantProps = {
    pageId: string | null;
    content: ConsultantSection | null;
...
const ConsultantForm = ({
    ...
    // Initial Values
    const initialValues: ConsultantSection = useMemo(
        () => ({
            id: content?.id || "",
            type: "Our Consultant",
    ...
    const handleSubmit = async (
        values: ConsultantSection,
        { resetForm }: FormikHelpers<ConsultantSection>,
