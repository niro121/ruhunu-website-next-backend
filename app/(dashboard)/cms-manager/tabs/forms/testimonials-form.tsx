...
type TestimonialsSection = Omit<Section, ""> & {
    data: {
        paddingtop: number;
...
type TestimonialsProps = {
    pageId: string | null;
    content: TestimonialsSection | null;
...
const TestimonialsForm = ({
    ...
    // Initial Values
    const initialValues: TestimonialsSection = useMemo(
        () => ({
            id: content?.id || "",
            type: "Testimonials",
    ...
    const handleSubmit = async (
        ...
        { resetForm }: FormikHelpers<TestimonialsSection>,
