...
type MediaSection = Omit<Section, ""> & {
    data: {
        title: string;
        subTitle: string;
        content: string;
...
const MediaForm = ({
    ...
    const [data, setData] = useState<MediaSection | null>(null);
    ...
    // Initial Values
    const initialValues: MediaSection = useMemo(
        () => ({
            id: data?.id || "",
            type: "Text-Media",
    ...
    const handleSubmit = async (
        values: MediaSection,
        { resetForm }: FormikHelpers<MediaSection>,
